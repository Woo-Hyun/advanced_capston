...
#define TX_TARGET_POSITION 0x607A, 0
...
int ecatUp()
{
	...
	const static ec_pdo_entry_reg_t throttle_domain_regs[] = {
		{0, THROTTLE_ID, MAXON_EPOS3, TX_CONTROL_WORD, &offset_ppm.control_word},
		{0, THROTTLE_ID, MAXON_EPOS3, TX_TARGET_POSITION, &offset_ppm.target_pos},
		{0, THROTTLE_ID, MAXON_EPOS3, TX_TARGET_VELOCITY, &offset_ppm.target_vel},
		{0, THROTTLE_ID, MAXON_EPOS3, TX_PROFILE_ACCELERATION, &offset_ppm.prof_accel},
		{0, THROTTLE_ID, MAXON_EPOS3, TX_PROFILE_DECELERATION, &offset_ppm.prof_decel},
		{0, THROTTLE_ID, MAXON_EPOS3, TX_PROFILE_VELOCITY, &offset_ppm.prof_vel},
		{0, THROTTLE_ID, MAXON_EPOS3, TX_OPERATION_MODE, &offset_ppm.mode_op},
		{0, THROTTLE_ID, MAXON_EPOS3, TX_DIGITAL_OUTPUT_FUNC, &offset_ppm.digital_out},

		{0, THROTTLE_ID, MAXON_EPOS3, RX_STATUS_WORD, &offset_ppm.status_word},
		{0, THROTTLE_ID, MAXON_EPOS3, RX_ACTUAL_POSITION, &offset_ppm.act_pos},
		{0, THROTTLE_ID, MAXON_EPOS3, RX_ACTUAL_VELOCITY, &offset_ppm.act_vel},
		{0, THROTTLE_ID, MAXON_EPOS3, RX_ACTUAL_CURRENT, &offset_ppm.act_cur},
		{0, THROTTLE_ID, MAXON_EPOS3, RX_FOLLOWING_ERR_VALUE, &offset_ppm.err_val},
		{0, THROTTLE_ID, MAXON_EPOS3, RX_OPERATION_MODE_DISPLAY, &offset_ppm.mode_display},
		{0, THROTTLE_ID, MAXON_EPOS3, RX_DIGITAL_INPUT_FUNC, &offset_ppm.digital_in},
		{0, THROTTLE_ID, MAXON_EPOS3, RX_INTERPOLATION_BUFFER, &offset_ppm.ip_buf},
		//{0,THROTTLE_ID, MAXON_EPOS3, RX_ACTUAL_CURRENT_AVG, &offset_ppm.act_cur_avg},
		{}};
	const static ec_pdo_entry_reg_t brake_domain_regs[] = {
		{0, BRAKE_ID, MAXON_EPOS3, TX_CONTROL_WORD, &offset_ppm.control_word},
		{0, BRAKE_ID, MAXON_EPOS3, TX_TARGET_POSITION, &offset_ppm.target_pos},
		{0, BRAKE_ID, MAXON_EPOS3, TX_TARGET_VELOCITY, &offset_ppm.target_vel},
		{0, BRAKE_ID, MAXON_EPOS3, TX_PROFILE_ACCELERATION, &offset_ppm.prof_accel},
		{0, BRAKE_ID, MAXON_EPOS3, TX_PROFILE_DECELERATION, &offset_ppm.prof_decel},
		{0, BRAKE_ID, MAXON_EPOS3, TX_PROFILE_VELOCITY, &offset_ppm.prof_vel},
		{0, BRAKE_ID, MAXON_EPOS3, TX_OPERATION_MODE, &offset_ppm.mode_op},
		{0, BRAKE_ID, MAXON_EPOS3, TX_DIGITAL_OUTPUT_FUNC, &offset_ppm.digital_out},

		{0, BRAKE_ID, MAXON_EPOS3, RX_STATUS_WORD, &offset_ppm.status_word},
		{0, BRAKE_ID, MAXON_EPOS3, RX_ACTUAL_POSITION, &offset_ppm.act_pos},
		{0, BRAKE_ID, MAXON_EPOS3, RX_ACTUAL_VELOCITY, &offset_ppm.act_vel},
		{0, BRAKE_ID, MAXON_EPOS3, RX_ACTUAL_CURRENT, &offset_ppm.act_cur},
		{0, BRAKE_ID, MAXON_EPOS3, RX_FOLLOWING_ERR_VALUE, &offset_ppm.err_val},
		{0, BRAKE_ID, MAXON_EPOS3, RX_OPERATION_MODE_DISPLAY, &offset_ppm.mode_display},
		{0, BRAKE_ID, MAXON_EPOS3, RX_DIGITAL_INPUT_FUNC, &offset_ppm.digital_in},
		{0, BRAKE_ID, MAXON_EPOS3, RX_INTERPOLATION_BUFFER, &offset_ppm.ip_buf},
		//{0,BRAKE_ID, MAXON_EPOS3, RX_ACTUAL_CURRENT_AVG, &offset_ppm.act_cur_avg},
		{}};

	const static ec_pdo_entry_reg_t clidar_domain_regs[] = {
		{0, CENTER_LIDAR_ID, MAXON_EPOS3, TX_CONTROL_WORD, &offset_ppm.control_word},
		{0, CENTER_LIDAR_ID, MAXON_EPOS3, TX_TARGET_POSITION, &offset_ppm.target_pos},
		{0, CENTER_LIDAR_ID, MAXON_EPOS3, TX_TARGET_VELOCITY, &offset_ppm.target_vel},
		{0, CENTER_LIDAR_ID, MAXON_EPOS3, TX_PROFILE_ACCELERATION, &offset_ppm.prof_accel},
		{0, CENTER_LIDAR_ID, MAXON_EPOS3, TX_PROFILE_DECELERATION, &offset_ppm.prof_decel},
		{0, CENTER_LIDAR_ID, MAXON_EPOS3, TX_PROFILE_VELOCITY, &offset_ppm.prof_vel},
		{0, CENTER_LIDAR_ID, MAXON_EPOS3, TX_OPERATION_MODE, &offset_ppm.mode_op},
		{0, CENTER_LIDAR_ID, MAXON_EPOS3, TX_DIGITAL_OUTPUT_FUNC, &offset_ppm.digital_out},

		{0, CENTER_LIDAR_ID, MAXON_EPOS3, RX_STATUS_WORD, &offset_ppm.status_word},
		{0, CENTER_LIDAR_ID, MAXON_EPOS3, RX_ACTUAL_POSITION, &offset_ppm.act_pos},
		{0, CENTER_LIDAR_ID, MAXON_EPOS3, RX_ACTUAL_VELOCITY, &offset_ppm.act_vel},
		{0, CENTER_LIDAR_ID, MAXON_EPOS3, RX_ACTUAL_CURRENT, &offset_ppm.act_cur},
		{0, CENTER_LIDAR_ID, MAXON_EPOS3, RX_FOLLOWING_ERR_VALUE, &offset_ppm.err_val},
		{0, CENTER_LIDAR_ID, MAXON_EPOS3, RX_OPERATION_MODE_DISPLAY, &offset_ppm.mode_display},
		{0, CENTER_LIDAR_ID, MAXON_EPOS3, RX_DIGITAL_INPUT_FUNC, &offset_ppm.digital_in},
		{0, CENTER_LIDAR_ID, MAXON_EPOS3, RX_INTERPOLATION_BUFFER, &offset_ppm.ip_buf},
		{}};

	const static ec_pdo_entry_reg_t llidar_domain_regs[] = {
		{0, LEFT_LIDAR_ID, MAXON_EPOS3, TX_CONTROL_WORD, &offset_ppm.control_word},
		{0, LEFT_LIDAR_ID, MAXON_EPOS3, TX_TARGET_POSITION, &offset_ppm.target_pos},
		{0, LEFT_LIDAR_ID, MAXON_EPOS3, TX_TARGET_VELOCITY, &offset_ppm.target_vel},
		{0, LEFT_LIDAR_ID, MAXON_EPOS3, TX_PROFILE_ACCELERATION, &offset_ppm.prof_accel},
		{0, LEFT_LIDAR_ID, MAXON_EPOS3, TX_PROFILE_DECELERATION, &offset_ppm.prof_decel},
		{0, LEFT_LIDAR_ID, MAXON_EPOS3, TX_PROFILE_VELOCITY, &offset_ppm.prof_vel},
		{0, LEFT_LIDAR_ID, MAXON_EPOS3, TX_OPERATION_MODE, &offset_ppm.mode_op},
		{0, LEFT_LIDAR_ID, MAXON_EPOS3, TX_DIGITAL_OUTPUT_FUNC, &offset_ppm.digital_out},

		{0, LEFT_LIDAR_ID, MAXON_EPOS3, RX_STATUS_WORD, &offset_ppm.status_word},
		{0, LEFT_LIDAR_ID, MAXON_EPOS3, RX_ACTUAL_POSITION, &offset_ppm.act_pos},
		{0, LEFT_LIDAR_ID, MAXON_EPOS3, RX_ACTUAL_VELOCITY, &offset_ppm.act_vel},
		{0, LEFT_LIDAR_ID, MAXON_EPOS3, RX_ACTUAL_CURRENT, &offset_ppm.act_cur},
		{0, LEFT_LIDAR_ID, MAXON_EPOS3, RX_FOLLOWING_ERR_VALUE, &offset_ppm.err_val},
		{0, LEFT_LIDAR_ID, MAXON_EPOS3, RX_OPERATION_MODE_DISPLAY, &offset_ppm.mode_display},
		{0, LEFT_LIDAR_ID, MAXON_EPOS3, RX_DIGITAL_INPUT_FUNC, &offset_ppm.digital_in},
		{0, LEFT_LIDAR_ID, MAXON_EPOS3, RX_INTERPOLATION_BUFFER, &offset_ppm.ip_buf},
		{}};

	const static ec_pdo_entry_reg_t rlidar_domain_regs[] = {
		{0, RIGHT_LIDAR_ID, MAXON_EPOS3, TX_CONTROL_WORD, &offset_ppm.control_word},
		{0, RIGHT_LIDAR_ID, MAXON_EPOS3, TX_TARGET_POSITION, &offset_ppm.target_pos},
		{0, RIGHT_LIDAR_ID, MAXON_EPOS3, TX_TARGET_VELOCITY, &offset_ppm.target_vel},
		{0, RIGHT_LIDAR_ID, MAXON_EPOS3, TX_PROFILE_ACCELERATION, &offset_ppm.prof_accel},
		{0, RIGHT_LIDAR_ID, MAXON_EPOS3, TX_PROFILE_DECELERATION, &offset_ppm.prof_decel},
		{0, RIGHT_LIDAR_ID, MAXON_EPOS3, TX_PROFILE_VELOCITY, &offset_ppm.prof_vel},
		{0, RIGHT_LIDAR_ID, MAXON_EPOS3, TX_OPERATION_MODE, &offset_ppm.mode_op},
		{0, RIGHT_LIDAR_ID, MAXON_EPOS3, TX_DIGITAL_OUTPUT_FUNC, &offset_ppm.digital_out},

		{0, RIGHT_LIDAR_ID, MAXON_EPOS3, RX_STATUS_WORD, &offset_ppm.status_word},
		{0, RIGHT_LIDAR_ID, MAXON_EPOS3, RX_ACTUAL_POSITION, &offset_ppm.act_pos},
		{0, RIGHT_LIDAR_ID, MAXON_EPOS3, RX_ACTUAL_VELOCITY, &offset_ppm.act_vel},
		{0, RIGHT_LIDAR_ID, MAXON_EPOS3, RX_ACTUAL_CURRENT, &offset_ppm.act_cur},
		{0, RIGHT_LIDAR_ID, MAXON_EPOS3, RX_FOLLOWING_ERR_VALUE, &offset_ppm.err_val},
		{0, RIGHT_LIDAR_ID, MAXON_EPOS3, RX_OPERATION_MODE_DISPLAY, &offset_ppm.mode_display},
		{0, RIGHT_LIDAR_ID, MAXON_EPOS3, RX_DIGITAL_INPUT_FUNC, &offset_ppm.digital_in},
		{0, RIGHT_LIDAR_ID, MAXON_EPOS3, RX_INTERPOLATION_BUFFER, &offset_ppm.ip_buf},
		{}};
	const static ec_pdo_entry_reg_t wheel_domain_regs[] = {
		{0, STEERING_ID, MAXON_EPOS3, TX_CONTROL_WORD, &offset_ppm.control_word},
		{0, STEERING_ID, MAXON_EPOS3, TX_TARGET_POSITION, &offset_ppm.target_pos},
		{0, STEERING_ID, MAXON_EPOS3, TX_TARGET_VELOCITY, &offset_ppm.target_vel},
		{0, STEERING_ID, MAXON_EPOS3, TX_PROFILE_ACCELERATION, &offset_ppm.prof_accel},
		{0, STEERING_ID, MAXON_EPOS3, TX_PROFILE_DECELERATION, &offset_ppm.prof_decel},
		{0, STEERING_ID, MAXON_EPOS3, TX_PROFILE_VELOCITY, &offset_ppm.prof_vel},
		{0, STEERING_ID, MAXON_EPOS3, TX_OPERATION_MODE, &offset_ppm.mode_op},
		{0, STEERING_ID, MAXON_EPOS3, TX_DIGITAL_OUTPUT_FUNC, &offset_ppm.digital_out},

		{0, STEERING_ID, MAXON_EPOS3, RX_STATUS_WORD, &offset_ppm.status_word},
		{0, STEERING_ID, MAXON_EPOS3, RX_ACTUAL_POSITION, &offset_ppm.act_pos},
		{0, STEERING_ID, MAXON_EPOS3, RX_ACTUAL_VELOCITY, &offset_ppm.act_vel},
		{0, STEERING_ID, MAXON_EPOS3, RX_ACTUAL_CURRENT, &offset_ppm.act_cur},
		{0, STEERING_ID, MAXON_EPOS3, RX_FOLLOWING_ERR_VALUE, &offset_ppm.err_val},
		{0, STEERING_ID, MAXON_EPOS3, RX_OPERATION_MODE_DISPLAY, &offset_ppm.mode_display},
		{0, STEERING_ID, MAXON_EPOS3, RX_DIGITAL_INPUT_FUNC, &offset_ppm.digital_in},
		{0, STEERING_ID, MAXON_EPOS3, RX_INTERPOLATION_BUFFER, &offset_ppm.ip_buf},
		//{0,STEERING_ID, MAXON_EPOS3, RX_ACTUAL_CURRENT_AVG, &offset_ppm.act_cur_avg},
		{}};
	const static ec_pdo_entry_reg_t gearstick_domain_regs[] = {
		{0, GEAR_ID, MAXON_EPOS3, TX_CONTROL_WORD, &offset_ppm.control_word},
		{0, GEAR_ID, MAXON_EPOS3, TX_TARGET_POSITION, &offset_ppm.target_pos},
		{0, GEAR_ID, MAXON_EPOS3, TX_TARGET_VELOCITY, &offset_ppm.target_vel},
		{0, GEAR_ID, MAXON_EPOS3, TX_PROFILE_ACCELERATION, &offset_ppm.prof_accel},
		{0, GEAR_ID, MAXON_EPOS3, TX_PROFILE_DECELERATION, &offset_ppm.prof_decel},
		{0, GEAR_ID, MAXON_EPOS3, TX_PROFILE_VELOCITY, &offset_ppm.prof_vel},
		{0, GEAR_ID, MAXON_EPOS3, TX_OPERATION_MODE, &offset_ppm.mode_op},
		{0, GEAR_ID, MAXON_EPOS3, TX_DIGITAL_OUTPUT_FUNC, &offset_ppm.digital_out},

		{0, GEAR_ID, MAXON_EPOS3, RX_STATUS_WORD, &offset_ppm.status_word},
		{0, GEAR_ID, MAXON_EPOS3, RX_ACTUAL_POSITION, &offset_ppm.act_pos},
		{0, GEAR_ID, MAXON_EPOS3, RX_ACTUAL_VELOCITY, &offset_ppm.act_vel},
		{0, GEAR_ID, MAXON_EPOS3, RX_ACTUAL_CURRENT, &offset_ppm.act_cur},
		{0, GEAR_ID, MAXON_EPOS3, RX_FOLLOWING_ERR_VALUE, &offset_ppm.err_val},
		{0, GEAR_ID, MAXON_EPOS3, RX_OPERATION_MODE_DISPLAY, &offset_ppm.mode_display},
		{0, GEAR_ID, MAXON_EPOS3, RX_DIGITAL_INPUT_FUNC, &offset_ppm.digital_in},
		{0, GEAR_ID, MAXON_EPOS3, RX_INTERPOLATION_BUFFER, &offset_ppm.ip_buf},
		//{0,GEAR_ID, MAXON_EPOS3, RX_ACTUAL_CURRENT_AVG, &offset_ppm.act_cur_avg},
		{}};
	...
	for (i = 0; i < MOTOR_NUM; i++)
	{
		if (i == BRAKE_ID)
		{
			profileMotorSpeed(i, 14285, 1000000000, 1000000000);
			//profileMotorSpeed(i, 3571, 150000, 150000);
		}
		else if (i == STEERING_ID)
		{
...
void disableMotor(int slave)
{
	...
	if ((errorCode = ecrt_master_sdo_download(master_info.master, 0, TX_CONTROL_WORD,
											  (unsigned char *)&controlWord, 2, &abortCode)) < 0)
	{
		printf("Abort Message : %x\n", abortCode);
		return -1;
